...
namespace Supermarket_mvp.Views
{
    public partial class ProductView : Form, IProductView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            {
                var result = MessageBox.Show("Are you sure you want to delete this Product?", "Delete Product", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        public void SetProductBillBindingSource(BindingSource ProductList)
        {
         DgProduct.DataSource = ProductList;
        }
        private static ProductView instance;
        public static ProductView GetInstance(Form patentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new ProductView();
                instance.MdiParent = patentContainer;
